        ...
        <>
            <div className="container-fluid">
                <div className="row">
                    ...
                    <div className="right-class col-md-8">
                        <div className="container-fluid">
                            <div className="another-class d-flex flex-column align-items-center justify-content-center" style={{ height: '100vh' }}>
                                <div className="Inner-Container" style={{width:'33rem'}}>
                                <h2 className="heading my-4">Let's Get Started</h2>
                                <div className="row">
